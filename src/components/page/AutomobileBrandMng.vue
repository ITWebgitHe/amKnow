<template>
    <div style="height:100%">
      ...
      <el-form :inline="true" :model="filters" ref="searchConditions">
        ...
        <el-form-item class="add-button">
          ...
          ></el-button>
            ...
            <el-table :data="showTable" :header-cell-style="{background:'#eef1f6',color:'#606266'}" highlight-current-row height="calc(100% - 60px)" style="border:1px solid #dfe6ec;" v-loading="loading">
                ...
                <el-table-column prop="country" label="国家" width="140" align="center" :formatter="formatCountry"></el-table-column>
                <el-table-column prop="company" label="所属公司" width="200" align="center" :formatter="formatCompany"></el-table-column>
                <el-table-column prop="founder" label="创始人" width="200" align="center" :formatter="formatFounder"></el-table-column>
      ...
      <el-button
        ...
        style="float:left"
      ></el-button>-->
            <el-pagination @current-change="handleCurrentChange" layout="total, prev, pager, next" :page-size="pagesize" :total="this.filterBrandInfs.length"></el-pagination>
        </el-col>

        <!--新增编辑界面-->
        <el-dialog :title="addOrEdit == 0 ? '新增' : '编辑'" :visible.sync="formVisible" :close-on-click-modal="false" @close="closeDialog" custom-class="brand-dialog-min-width" width="32%">
