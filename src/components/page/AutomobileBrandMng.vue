    ...
    methods: {
        ...
        onConfirm () {
            ...
            if (this.title = '回复留言') {
                ...
                axios
                    .post(
                        "http://192.168.43.37:9001/pic_lib/message-board/insert", params)
                    .then(res => {
        ...
        getInfoList () {
            ...
            axios
                .get(
                    "http://192.168.43.37:9001/pic_lib/message-board/pageList", {
                    params: {
        ...
        onDelate(row) {
           let that = this;
            axios
                .get(
                    "http://192.168.43.37:9001/pic_lib/message-board/delete", {
                    params: {
                        id: row.id,
                        type: row.type,
                        userId:this.userInfo.id,
